...
namespace NativeDump
{
    internal class Overwrite
    {
        ...
        public static IntPtr GetLibAddress(string libname)
        {
            ...
            IntPtr lib_baseaddress = helperGetModuleHandle(libname);
            return lib_baseaddress;
        }


        public static Delegate GetFuncDelegate(IntPtr lib_baseaddress, string funcname, Type delegate_test)
        {
            ...
            IntPtr func_addr = helperGetProcAddress(lib_baseaddress, funcname);
